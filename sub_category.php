...
<div id="itemSort">
    ...
    <div id="itemlist">
<?php   
        $sub_category = $_GET['page'];
         $query = "SELECT product_id, product_name, product_price,main_category, sub_category, tn_image from products WHERE sub_category='$sub_category'";
