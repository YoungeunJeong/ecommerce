...
<div class="topsort">
    ...
    <div id="itemlist">
        <?php
            $query = "SELECT product_id, product_name, product_price,main_category, sub_category, tn_image from products ";
                ...
                <div class=\"product-wrap\" data-name=\"$product_name\" data-price=\"$product_price\">
                    <a href=\"detail.php?page=$product_id\">
                        <div class=\"product-img\">
                            <img src=\"img/Image_Thumbnail/$tn_image\" alt=\"product #$product_id\" width=\"350\" height=\"350\">
                        </div>
